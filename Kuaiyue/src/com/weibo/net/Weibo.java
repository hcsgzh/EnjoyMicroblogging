...
public class Weibo {
    ...
    public static final String DEFAULT_REDIRECT_URI = "wbconnect://success";// 鏆備笉鏀寔
    public static final String DEFAULT_CANCEL_URI = "wbconnect://cancel";// 鏆備笉鏀寔
     ...
     *            鎺堟潈缁撴灉鐩戝惉鍣�
     */
    public void authorize(Activity activity, final WeiboDialogListener listener, LinearLayout loginLinear) {
    	this.loginLinear = loginLinear;
...
//        String url = URL_OAUTH2_ACCESS_AUTHORIZE + "?" + Utility.encodeUrl(parameters);
        ...
        if (context.checkCallingOrSelfPermission(Manifest.permission.INTERNET) != PackageManager.PERMISSION_GRANTED) {
        	...
        	Log.i("loginLinear", "loginLinear");
//        	loginLinear.addView(new WeiboDialog(this, context, url, listener),
