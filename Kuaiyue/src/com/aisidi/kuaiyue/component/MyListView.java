...
public class MyListView extends ListView implements OnScrollListener {
	...
	private OnToNextPageListener listener;
	...
	private void init(Context context) {
		...
		customerBar = (CustomerBar)footView.findViewById(R.id.customerBar);
	...
	public void setOnToNextPageListener(OnToNextPageListener l)
	{
		this.listener = l;
	}
	...
	{
		void toNextPage(int totalItemCount);
	}
